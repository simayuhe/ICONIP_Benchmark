...
from SIL.segment_tree import SumSegmentTree, MinSegmentTree
...
class SelfImitation(object):
    ...
    def __init__(self, model_ob, model_vf, model_entropy, 
        ...
        if isinstance(ac_space, spaces.Box):
            # Continuous control
            self.A = tf.compat.v1.placeholder(tf.float32, [None, ac_space.shape[0]])
        ...
        self.W = tf.compat.v1.placeholder(tf.float32, [None])
        self.build_loss_op()
