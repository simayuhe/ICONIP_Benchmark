...
#         print("ep,stepcount",epinfos,stepcount)
        ...
        if counter%args.checkpoint_freq==0:
            ...
            np.save(args.resultspath+args.env+"_ICM_"+"rew.npy",ep_reward2save)
            np.save(args.resultspath+args.env+"_ICM_"+"rew_times.npy",ep_reward_times2save)
            np.save(args.resultspath+args.env+"_ICM_"+"ep_len.npy",ep_len2save)
#         if info['update']:
#             print(counter)
#             counter += 1
#             if counter>2:
