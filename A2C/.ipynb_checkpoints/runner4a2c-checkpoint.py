...
#         print("mei ci gengxin ",len(obs))
        ...
        if update%args.checkpoint_freq ==0:
            ...
            np.save(args.resultspath+args.env+"_A2C_"+"rew.npy",ep_reward2save)
            np.save(args.resultspath+args.env+"_A2C_"+"rew_times.npy",ep_reward_times2save)
            np.save(args.resultspath+args.env+"_A2C_"+"ep_len.npy",ep_len2save)
