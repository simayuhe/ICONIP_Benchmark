...
from Common.Private_tf_utils import conv, fc, conv_to_fc, batch_to_seq, seq_to_batch,lnlstm,lstm
    ...
    def network_fn(X):
        ...
        with tf.compat.v1.variable_scope("convnet"):
            ...
            for num_outputs, kernel_size, stride in convs:
                print("out",out,"num_outputs, kernel_size, stride",num_outputs, kernel_size, stride)
                #out Tensor("q_func/truediv:0", shape=(None, 84, 84, 1), dtype=float32) out.shape (None, 84, 84, 1) num_outputs, kernel_size, stride 32 8 4
                ...
                #                            **conv_kwargs)
                out = tf.compat.v1.keras.layers.Conv2D(
                                           filters=num_outputs,
                                           kernel_size=kernel_size,
